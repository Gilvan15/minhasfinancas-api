...
import com.gilvan.minhasfinancas.model.dto.AtualizaStatusDTO;
import com.gilvan.minhasfinancas.model.dto.LancamentoDTO;
	...
	public ResponseEntity atualizar(@PathVariable Long id, @RequestBody AtualizaStatusDTO dto ) {
		return service.obterPorId(id).map(entity -> {
			...
			if( statusSelecionado == null ) {
				return ResponseEntity.badRequest().body("Não foi possível atualizar o status de lancamento, envia um status válido!");
			}
